...
sub _build_column_attribute_metaclass {
    ...
    return Moose::Meta::Class->create_anon_class(
        ...
        roles        => [ qw(MooseX::DBIC::Meta::Role::Attribute MooseX::DBIC::Meta::Role::Attribute::Column) ],
        cache        => 1,
    )->name;
}
...
sub _build_relationship_attribute_metaclass {
    ...
    return Moose::Meta::Class->create_anon_class(
        superclasses => ['Moose::Meta::Attribute'],
        roles => [ qw(MooseX::DBIC::Meta::Role::Attribute MooseX::DBIC::Meta::Role::Attribute::Column MooseX::DBIC::Meta::Role::Attribute::Relationship) ],
        cache => 1,
    )->name;
}
